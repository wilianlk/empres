...
CREATE TABLE `coleccion` (
  `id_coleccion` bigint(20) NOT NULL AUTO_INCREMENT,
  `numero_coleccion` varchar(50) NOT NULL,
  `year_coleccion` varchar(4) NOT NULL,
...
-- Dump completed on 2018-06-26 10:16:39
