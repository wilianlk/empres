...
class BundleGeneratorTest extends GeneratorTest
{
    public function testGenerateYaml()
    {
        ...
        $files = array(
            ...
            'Resources/views/Default/timeclock_admin.html.twig',
        ...
        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Resources/views/Default/timeclock_admin.html.twig');
