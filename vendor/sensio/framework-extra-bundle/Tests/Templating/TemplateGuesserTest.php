...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('FooBundle:Foo:timeclock_admin.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:Bar:timeclock_admin.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithCascadingParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:FooBar:timeclock_admin.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals(':OutOfBundle:timeclock_admin.html.twig', (string) $templateReference);
    }
